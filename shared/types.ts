// ============================================================
// SafeSignal PH — Shared Types
// ============================================================

export type AlertStatus = 'ACTIVE' | 'ACKNOWLEDGED' | 'RESOLVED' | 'CANCELLED' | 'FALSE_ALARM';
export type CancellationReason = 'ACCIDENTAL' | 'SITUATION_RESOLVED' | 'OTHER';
export type OfficerRole = 'DISPATCHER' | 'STATION_ADMIN';
...
export interface AlertLocationHistory {
  id: string;
  alert_id: string;
  lat: number;
  lng: number;
...
export interface CitizenTrustScore {
  id: string;
  citizen_id: string;
  score: number;
  total_alerts: number;
...
// API response types
export interface AlertWithCitizen extends SOSAlert {
  citizen: Citizen;
  trust_score: CitizenTrustScore;
  assigned_officer?: Officer;
  location_history: AlertLocationHistory[];
}
