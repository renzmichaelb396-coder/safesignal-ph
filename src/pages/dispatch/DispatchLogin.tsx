    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#0d1117', padding: '16px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      <div style={{ width: '100%', maxWidth: '420px', backgroundColor: '#161b22', border: '1px solid #30363d', borderRadius: '8px', padding: '40px 32px', boxShadow: '0 10px 40px rgba(0,0,0,0.4)' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#c9d1d9', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Email Address</label>
          ...
          <div>
            <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#c9d1d9', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Badge Number</label>
          ...
          <div>
            <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#c9d1d9', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Password</label>
        ...
        <div style={{ marginTop: '32px', paddingTop: '24px', borderTop: '1px solid #30363d' }}>
          <p style={{ fontSize: '12px', color: '#8b949e', margin: '0 0 10px 0', textTransform: 'uppercase', fontWeight: 600, letterSpacing: '0.5px' }}>Demo Credentials</p>
          <button type="button" onClick={fillDispatcherCredentials}
          ...
          <button type="button" onClick={fillOfficerCredentials}
            style={{ width: '100%', padding: '10px 12px', fontSize: '13px', fontWeight: 600, color: '#3fb950', backgroundColor: 'transparent', border: '1px solid #30363d', borderRadius: '6px', cursor: 'pointer' }}>
            Officer (Juan dela Cruz / PNP-101)
          </button>
        </div>
        <p style={{ marginTop: '24px', textAlign: 'center', fontSize: '11px', color: '#8b949e' }}>RespondPH v1.0 — Authorized Personnel Only</p>
      </div>
    </div>
  );
}
